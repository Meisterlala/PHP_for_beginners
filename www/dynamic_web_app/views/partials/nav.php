            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="index.php" class=" text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'index.php') ?
                            'bg-gray-900 text-white' : '' ?> rounded-md  px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Home</a>
                        <a href="about.php" class=" text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'about.php') ?
                            'bg-gray-900 text-white' : '' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About</a>
                        <a href="contact.php" class="text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'contact.php') ?
