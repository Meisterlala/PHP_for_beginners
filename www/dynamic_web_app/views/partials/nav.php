            ...
            <div class="flex items-center">
                ...
                <div class="md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="./" class=" text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'index') || str_ends_with($_SERVER['REQUEST_URI'], "/") ?
                            'bg-gray-900 text-white' : '' ?> rounded-md  px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Home</a>
                        <a href="about" class=" text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'about') ?
                            'bg-gray-900 text-white' : '' ?> rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About</a>
                        <a href="contact" class="text-gray-300 <?= str_contains($_SERVER['REQUEST_URI'], 'contact') ?
